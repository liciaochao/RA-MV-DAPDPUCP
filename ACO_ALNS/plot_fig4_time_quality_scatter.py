...
def main():
    try:
        ...
        legend = fig.legend(
            ...
            loc='upper left',
            bbox_to_anchor=(panel_left, 0.98),
        ...
        # 2) dominance text under legend
        fig.canvas.draw()
        legend_bbox = legend.get_window_extent(fig.canvas.get_renderer())
        legend_bottom_fig = legend_bbox.y0 / fig.bbox.height

        line_gap = 0.052
        line_sep = 0.018

        y_cursor = legend_bottom_fig - 0.04
